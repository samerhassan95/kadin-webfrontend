...
export const ExpandableShop = ({ shop, defaultOpen, children, extra }: ExpandableShopProps) => (
  <Disclosure defaultOpen={defaultOpen}>
    {({ open }) => (
      <>
        <div className="flex w-full justify-between items-center rounded-xl py-2">
          ...
          <Disclosure.Button
            className={clsx(
              "p-2 text-left text-sm font-medium hover:brightness-90 transition-all focus-ring rounded"
            )}
          >
            <ChevronRightIcon
