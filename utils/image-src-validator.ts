 ...
 */
export function validateImageSrc(src: string | undefined | null): string | null {
  if (!src) return null;
 ...
 */
export function safeImageSrc(src: string | undefined | null, fallback?: string): string | null {
