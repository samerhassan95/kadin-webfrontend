...
import { validateImageSrc } from "@/utils/image-src-validator";
...
export const ImageWithFallBack = (props: ImageProps) => {
  ...
  // Validate the src before passing to Image component
  const validSrc = validateImageSrc(typeof src === 'string' ? src : undefined);
  const shouldShowFallback = isError || !validSrc;

  return (
    <Image
      {...rest}
      loader={shouldShowFallback ? undefined : loader}
      src={shouldShowFallback ? "/img/image-load-failed.png" : validSrc!}
