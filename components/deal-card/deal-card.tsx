      ...
      >
        <div className="flex items-center gap-7">
          {img ? (
            ...
            <div className="w-[75px] h-[78px] bg-gray-200 rounded flex items-center justify-center">
        ...
        <div className="md:px-8 py-8 px-4">
          <div className="rounded-3xl bg-white dark:bg-gray-inputBorder py-4 px-7 flex items-center gap-6 mr-10 rtl:ml-10 rtl:mr-0">
            {img ? (
              ...
              <div className="w-[75px] h-[75px] bg-gray-200 rounded-3xl flex items-center justify-center">
                <span className="text-gray-500 text-xs">No Image</span>
              </div>
            )}
